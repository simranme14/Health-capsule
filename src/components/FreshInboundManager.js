...
class FreshInboundManager extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get(`http://localhost:8080/api/freshinboundmanager/${this.state.user}`)
        ...
        return (
            <CustomizedDialogs popupOpen={true} setOpen={this.props.setOpen}>
                <MDBTable style={{ overflow: 'auto', zoom: '75%' }}>
                    <MDBTableHead>
                        <tr>
                            <td style={{whiteSpace: 'nowrap'}}>Ticket Number</td>
                            <td style={{whiteSpace: 'nowrap'}}>Assignee ID</td>
                            <td style={{whiteSpace: 'nowrap'}}>Assignee Name</td>
                            <td style={{whiteSpace: 'nowrap'}}>Assigned Group</td>
...
export default FreshInboundManager