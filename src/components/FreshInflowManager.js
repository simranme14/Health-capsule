...
class FreshInflowManager extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get(`http://localhost:8080/api/freshinflowmanager/${this.state.user}`)
    ...
    render() {
        return (
            <CustomizedDialogs popupOpen={true} setOpen={this.props.setOpen}>
                <MDBTable style={{overflow:'auto', zoom:'67.5%'}}>
                    <MDBTableHead>
                        <tr>
                            ...
                            <td style={{whiteSpace: 'nowrap'}}>Days Open</td>
                        </tr>
                    </MDBTableHead>
                    <MDBTableBody>
                        {
...
export default FreshInflowManager